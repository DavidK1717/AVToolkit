...
namespace Util
{
    [ToolboxBitmap(typeof(EndlessProgressBar), "ToolBoxGraphic.bmp")]
    public partial class EndlessProgressBar : UserControl
    {
        ...
        #region Enumerations
        public enum EndlessProgressBarStyleConstants
        {
            LEFTTORIGHT,
            LEFTANDRIGHT
        }
        public enum EndlessProgressBarTypeConstants
        {
            BOXTYPE,
            GRAPHICTYPE
        }
        public enum EndlessProgressBarBoxStyleConstants
        {
            SOLIDSAMESIZE,
            BOXAROUND,
            SOLIDBIGGER,
        ...
        #region Properties
        private EndlessProgressBarTypeConstants _ProgressType = EndlessProgressBarTypeConstants.BOXTYPE;
        private bool ShouldSerializeProgressType()
        {
            return _ProgressType != EndlessProgressBarTypeConstants.BOXTYPE;
        }
        [Description("Determines the type of progress bar")]
        public EndlessProgressBarTypeConstants ProgressType
        {
            get
            {
        ...
        private EndlessProgressBarStyleConstants _ProgressStyle = EndlessProgressBarStyleConstants.LEFTTORIGHT;
        private bool ShouldSerializeProgressStyle()
        {
            return _ProgressStyle != EndlessProgressBarStyleConstants.LEFTTORIGHT;
        }
        [Description("Indicates the progress indicator rotation style")]
        public EndlessProgressBarStyleConstants ProgressStyle
        {
            get
            {
        ...
        private EndlessProgressBarBoxStyleConstants _ProgressBoxStyle = EndlessProgressBarBoxStyleConstants.SOLIDSAMESIZE;
        private bool ShouldSerializeProgressBoxStyle()
        {
            return _ProgressBoxStyle != EndlessProgressBarBoxStyleConstants.SOLIDSAMESIZE;
        }
        public EndlessProgressBarBoxStyleConstants ProgressBoxStyle
        {
            get
            {
        ...
        private void TimerHandler(object sender, System.EventArgs e)
        {
            ...
            {
                if (this._ProgressStyle == EndlessProgressBarStyleConstants.LEFTTORIGHT)
                {
                    this._Position = 0;
                }
                else
                ...
                if (iBoxSize > 3)
                {
                    do
                    {
                        ...
                        else
                        {
                            ...
                            if ((this._NormalImage != null) && (this._ProgressType == EndlessProgressBarTypeConstants.GRAPHICTYPE))
                            {
        ...
        {
            if ((this._PointImage != null) && (this._ProgressType == EndlessProgressBarTypeConstants.GRAPHICTYPE))
            {
            ...
            {
                Rectangle R2;
                if (this.ProgressBoxStyle == EndlessProgressBarBoxStyleConstants.SOLIDSAMESIZE)
                {
                ...
                else if (this.ProgressBoxStyle == EndlessProgressBarBoxStyleConstants.BOXAROUND)
                {
                    this._Graphics.DrawRectangle(new Pen(_IndicatorColor), Rect);
                    R2 = new Rectangle(Rect.Left + 3, Rect.Top + 3, Rect.Width - 5, Rect.Height - 5);
                    this._Graphics.FillRectangle(new SolidBrush(_IndicatorColor), R2);
                }
                else if (this.ProgressBoxStyle == EndlessProgressBarBoxStyleConstants.SOLIDBIGGER)
                {
                    this._Graphics.FillRectangle(new SolidBrush(_IndicatorColor), Rect);
                }
                else if (this.ProgressBoxStyle == EndlessProgressBarBoxStyleConstants.SOLIDSMALLER)
                {
